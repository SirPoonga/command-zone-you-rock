...
def _parse_name_only_banner(text: str) -> str:
    ...
    rejected_words = {
        "BACK", "COMMAND", "COMMANDZONE", "COM", "HTTP", "HTTPS", "LESS",
        "MORE", "PATREON", "PRO", "READ", "ROCK", "SHOW", "SPONSOR",
        "SPONSORED", "SUPPORT", "THE", "ULTRA", "VISIT", "WWW",
        "YOUTUBE", "YOU", "ZONE",
    }
    rejected_phrases = {
        "READMORE", "SHOWLESS", "LEARNMORE", "SEELESS", "SEEMORE",
    }
    ...
    for candidate in candidates:
        ...
        if normalized_words & rejected_words:
            continue
        ...
        if cleaned_words & rejected_words:
            continue
